    ...
    public class IM_Manager : EditorWindow
    {
        ...
        static ItemDataBaseList inventoryItemList
        {
            get
            {
                ...
                {
                    return CreateItemDatabase.createItemDatabase();
                }
                else
                {
                    return (ItemDataBaseList)Resources.Load("ItemDatabase");
                }
            }
        }
        ...
        static InputManager inputManagerDatabase
        {
            get
            {
                if (Resources.Load("InputManager") == null)
                {
                    return CreateInputManager.createInputManager();
                }
                else
                {
                    return (InputManager)Resources.Load("InputManager");
                }
            }
        }


        static ItemAttributeList itemAttributeList
        {
            get
            {
                if (Resources.Load("AttributeDatabase") == null)
                {
                    return CreateAttributeDatabase.createItemAttributeDatabase();
                }
                else
                {
                    return (ItemAttributeList)Resources.Load("AttributeDatabase");
                }
            }
        }

        static ItemCategoryList itemCategoryList
        {
            get
            {
                if (Resources.Load("CategoryDatabase") == null)
                {
                    return CreateCategoryDatabase.createItemCategoryDatabase();
                }
                else
                {
                    return (ItemCategoryList)Resources.Load("CategoryDatabase");
                }
            }
        }
        ...
        bool showItemCategories;
        string addCategoryName = "";
        int categoryAmount = 1;
        int[] categoryName;
        int[] categoryValue;

        int[] categoryNamesManage = new int[100];
        int[] categoryValueManage = new int[100];
        int categoryAmountManage;
        ...
        void addCategory()
        {
            EditorUtility.SetDirty(itemCategoryList);
            ItemCategory newCategory = new ItemCategory();
            newCategory.categoryName = addCategoryName;
            itemCategoryList.itemCategoryList.Add(newCategory);
            addCategoryName = "";
            EditorUtility.SetDirty(itemCategoryList);
        }
